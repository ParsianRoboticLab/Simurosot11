...
//					AfxMessageBox("Information error 3");
			...
			switch (iNum) {
				case 1://��һ�Ŷ�Ա������
					...
					} else if (m_iSide == RIGHT_TO_LEFT)//����Ǵ��������������ô�󷽶�Ա����ʹ���op����
					{
						op.position1.x = x;
						op.position1.y = y;
					}
				...
				case 12:
					if (m_iSide == LEFT_TO_RIGHT) {
						op.position1.x = x;
						op.position1.y = y;
					} else if (m_iSide == RIGHT_TO_LEFT)//�ҷ�һ�Ŷ�Ա����
					{
						r[0][0].position.x = x;
						r[0][0].position.y = y;
						r[0][0].angle = (int) angle;
...
void CBaseAgent::SendCommand() {
	...
	if (m_iSide == LEFT_TO_RIGHT) {
		msg.Format(
				"((player left 1) %d %d) ((player left 2) %d %d) ((player left 3) %d %d) ((player left 4) %d %d) ((player left 5) %d %d) ((player left 6) %d %d) ((player left 7) %d %d) ((player left 8) %d %d) ((player left 9) %d %d) ((player left 10) %d %d) ((player left 11) %d %d)",
		...
		msg.Format(
				"((player right 1) %d %d) ((player right 2) %d %d) ((player right 3) %d %d) ((player right 4) %d %d) ((player right 5) %d %d) ((player right 6) %d %d) ((player right 7) %d %d) ((player right 8) %d %d) ((player right 9) %d %d) ((player right 10) %d %d) ((player right 11) %d %d)",
